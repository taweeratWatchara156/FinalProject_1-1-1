    ...
    <div className='flex-1 flex px-2 sm:px-0 justify-center items-center'>
        <div className='w-full sm:w-auto px-5 md:px-10 py-10 flex flex-col gap-5 bg-[#86B0BD] rounded-md text-white shadow-xl border-[#67828b] border-2 border-dotted'>
            ...
            <div className='flex sm:hidden flex-col gap-3 w-full'>
                ...
                <Input size="middle" style={{color: "#3f5860"}} placeholder='Email' type='email' prefix={<FaUser className='text-[#3f5860]' />}/>
                <Input.Password size="middle" style={{color: "#3f5860"}} placeholder='Password' prefix={<FaLock className='text-[#3f5860]' />}/>
                <Input.Password size="middle" style={{color: "#3f5860"}} placeholder='Confirm Password' prefix={<FaLock className='text-[#3f5860]' />}/>
            </div>

            <div className='hidden sm:flex'><Button size='large' style={{backgroundColor: "#E2A16F", border: "#a06f49", color:"white"}} className='w-full'>Sign up</Button></div>
            <div className='flex sm:hidden'><Button size='middle' style={{backgroundColor: "#E2A16F", border: "#a06f49", color:"white"}} className='w-full'>Sign up</Button></div>
